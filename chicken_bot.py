...
# Bot instance
# ---------------------------------------------------------------------------
bot = telebot.TeleBot(config.CHICKEN_BOT_TOKEN, parse_mode="Markdown")
...
# Callback-data prefixes for inline buttons (must differ from aviator_bot)
...
def handle_start(message: telebot.types.Message) -> None:
    ...
    if status == sheets.STATUS_APPROVED:
        text = (
            ...
            "_Pick your path wisely. Good luck!_ 💰"
        )
        ...
        text = (
            f"💰 *Welcome to SIGNAL-BOT | CHICKEN ROAD 2!* 🐓\n\n"
...
def handle_getlog(message: telebot.types.Message) -> None:
    ...
    bot.reply_to(
        message,
        f"📊 *Chicken Road Members Database:*\n[Open Spreadsheet]({_SHEET_URL})",
    )
...
def _receive_verification_photo(message: telebot.types.Message, member_id: str) -> None:
    ...
    caption = (
        ...
        "━━━━━━━━━━━━━━━━━━━━━━━\n"
        f"🤖 *Bot:* Chicken Road 2 Signal Bot\n"
